...
float CheatMath::abs(float a) {
	if (a < 0)
		return a * -1;
	return a;
}
float CheatMath::DegreesToRadians(float Degrees)
{
	return Degrees * PI / 180.0f;
}

float CheatMath::RadiansToDegrees(float Radians)
{
	return Radians * 180.0f / PI;
}

float CheatMath::pow(float num, int power) {
	float ret = 1;
...
float CheatMath::root(float num, int nroot) {
...
float CheatMath::cos(float AnglesDeg)
{
...
float CheatMath::tan(float AnglesDeg)
{
...
double CheatMath::atan(double x, int n)
{
...
double CheatMath::atan(double y, double x)
{
